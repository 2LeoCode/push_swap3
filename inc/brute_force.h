...
/*   Updated: 2021/10/12 16:13:26 by Leo Suardi       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_3numbers(t_stack *st[2], t_queue *instr, const size_t size);
void	sort_4numbers(t_stack *st[2], t_queue *instr, const size_t size);
void	sort_5numbers(t_stack *st[2], t_queue *instr, const size_t size);
